...
interface ChatContextValue {
  ...
  typingByRoom: Record<string, string[]>; // roomId -> displayNames currently typing
...
useEffect(() => {
  ...
  // Keep a ref mirror of activeRoomId so the socket event handlers (set up
  // once) always read the latest value without needing to re-subscribe.
  ...
  // Refs used inside stable socket handlers above (avoids stale closures
